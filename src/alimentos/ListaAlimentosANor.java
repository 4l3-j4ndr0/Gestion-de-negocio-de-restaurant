...
import static alimentos.ListaAlimentosAd.tablaAlimentos;
...
public class ListaAlimentosANor extends javax.swing.JInternalFrame {
        ...
        tipoAl.addItemListener(new ItemListener() {
            ...
            public void itemStateChanged(ItemEvent ie) {
                ...
                if (tipoAl.getSelectedIndex() == 1) {
                    ...
                    OpcionesAl.listar4(tipoAl.getSelectedItem().toString());
                }
    ...
    private void buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarKeyReleased
        ...
        OpcionesAl.listar4(buscar.getText());
...
//                        JOptionPane.showMessageDialog(this, "Debe ingresar algun valor mayor que 0");
                        ...
                        if(tablaAlimentos.getValueAt(fila, 3)!=null){
                            ...
                            if (cod.equals(com)) {
                                ...
                                c++;
                                calcular();
                                CajaNor.recibi.setText("");
                                CajaNor.cambio.setText("");
                        }
                                }
                        if (c == 0) {
        ...
        OpcionesAl.listar4("");
        Alimentos.resizeColumnWidth(ventas.CajaNor.tablaCaja);
        buscar.setText("");
